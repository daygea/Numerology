...
setInterval(function () {
    if (window.outerWidth - window.innerWidth > 200 || window.outerHeight - window.innerHeight > 200) {
        ...
        const meanings = {
            1: "Good, talks about a long journey, traveling, successful marriage, long life, prosperity, and good health. If it appears for someone, their journey will be successful. Represents Leadership & Independence. Traits: Ambitious, pioneering, determined, strong-willed. Meaning: The energy of new beginnings, individuality, and self-motivation.",

            2: "Good, prosperity, good market, good spouse, no ailment. Warning: A parent must take care of their child, or the child may turn against them. Represents Harmony & Partnership. Traits: Diplomatic, cooperative, intuitive, sensitive. Meaning: Represents duality, balance, relationships, and teamwork.",
